...
public class GraphMenuBar extends MenuBar{
    ...
    public GraphMenuBar(MainWindow window, WindowManager windowManager){
        ...
        file.getItems().add(new MenuItem("New Graph"));
        ...
        file.getItems().add(new SeparatorMenuItem());
        file.getItems().add(new MenuItem("Close Graph"));
        ...
        closeWindow.setAccelerator(KeyCombination.keyCombination("CTRL + W"));
        MenuItem exit = new MenuItem("Close All and Exit");
        file.getItems().add(exit);
        exit.setOnAction(e -> {
            windowManager.closeAll();
        });
        exit.setAccelerator(KeyCombination.keyCombination("CTRL + SHIFT + W"));
