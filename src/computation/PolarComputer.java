...
public class PolarComputer extends AbstractPlotComputer<PolarPlot, PolarCurveData>{
    public PolarComputer(PolarPlot plot, PolarCurveData data){
        super(plot, data);
    }
    ...
    private void adaptiveSamplePolar(
    ...
    private ArrayList<Segment2D> generateChunkSegments(Function<Double, Double> x, Function<Double, Double> y, ParametricCurveChunk chunk, ViewportState state, double toleranceX, double toleranceY){
        ...
        ArrayList<Segment2D> segments = new ArrayList<>();
        adaptiveSamplePolar(x, y, state, chunk.parameterRange.a, chunk.parameterRange.b, points, toleranceX, toleranceY, 0);
    ...
    public BoundingBox computeBounds(double t0, double t1, EvaluationContext context){
        ...
        int samples = 128;
        Function<Double, Double> x = t -> plot.sampleX(t, context);
        Function<Double, Double> y = t -> plot.sampleY(t, context);
